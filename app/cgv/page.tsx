  ...
  return (
    <>
      <section
        ...
        style={{ paddingTop: 'clamp(60px, 8vh, 100px)', paddingBottom: 'clamp(32px, 4vh, 48px)' }}
      >
          ...
          >
              ...
              <BulletList
                items={[
                  ...
                  [
                    ...
                    "disponible à Kinshasa. L'accès est activé sous 24h après validation manuelle par FK Éditions.",
                  ],
                ]}
              />
            ...
            <Section id="4" title="Livraison des produits numériques">
              <P>
                ...
                espace personnel{' '}
                <Link href="/bibliotheque" style={{ color: 'var(--accent)', textDecoration: 'none', fontWeight: 500 }}>
                  Ma bibliothèque
                </Link>
                .
              </P>
...
function P({
  ...
  return (
    <p style={{ fontSize: 15, color: 'var(--ink-soft)', lineHeight: 1.7, ...style }}>
      {children}
    </p>
  )
}
